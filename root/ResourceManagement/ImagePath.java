...
public class ImagePath {
    ...
    private static String BONUSROLLEN_PATH = CARD_PATH + "Bonusrollen\\";
    private static String OFFENE_BONUSROLLEN_PATH = BONUSROLLEN_PATH + "Augensymbolkarten\\";
    ...
    public static String VAMPIRE_ICON = ICON_PATH + "Vampire" + IMAGE_FILE_EXTENSION;
    ...
    public static String HENKER_KARTE = ÜBERLÄUFER_PATH + "Henker" + IMAGE_FILE_EXTENSION;
    ...
    public static String SCHAFSPELZ_KARTE = BONUSROLLEN_PATH + "Schafspelz" + IMAGE_FILE_EXTENSION;
