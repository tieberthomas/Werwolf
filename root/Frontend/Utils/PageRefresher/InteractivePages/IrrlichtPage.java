...
import root.Frontend.Utils.PageRefresher.InteractivePages.InteractiveElementsDtos.IrrlichPageElementsDto;
...
public class IrrlichtPage extends RefreshedPage {
    private IrrlichPageElementsDto interactiveElementsDto;
    ...
    protected void setupPageElementsDtos() {
        interactiveElementsDto = new IrrlichPageElementsDto(addIrrlichtButton, labelTable, deleteTable, nameComboBox);
    }
    ...
    private void deleteIrrlicht(ActionEvent ae) {
        int index = findIrrlichtIndex(ae);
    ...
    private int findIrrlichtIndex(ActionEvent ae) {
        int keinIrrlicht = -1;
